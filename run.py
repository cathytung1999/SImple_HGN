...
from models.GNN import SimpleHGN
import dgl
...
def run_model_DBLP(args):
    ...
    for _ in range(args.repeat):
        ...
        net = SimpleHGN(g, in_dims, num_classes, args.edge_feats, len(dl.links['count'])*2+1, args.hidden_dim, args.num_layers, heads, args.dropout, args.dropout, args.slope, True, 0.05)
        net.to(device)
